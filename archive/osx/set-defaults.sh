...
# Set computer name
COMPUTERNAME="Anahit-MBP"
HOSTNAME='Anahit-MBP'
LOCALHOSTNAME='Anahit-MBP'

sudo -v # SUDO Password

# SUDO session expiration extended
...
defaults write com.apple.Safari ShowFavoritesBar -bool false   # Hide Safari's bookmark bar.
...
defaults write -g KeyRepeat -int 0 # Set a really fast keyboard repeat rate.
...
defaults write NSGlobalDomain AppleFontSmoothing -int 2 # Enable sub-pixel rendering on non-Apple LCDs.
...
sleep 1 #Time Delay 1 second

echo "Success! Defaults are set."
echo "Some changes will not take effect until you reboot your machine."

function reboot() { # User is given choice to Reboot machine
